...
class MySpace_Profile_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        echo '<a href="https://www.instagram.com/nomadpub/">Pics</a> | ';
...
// Custom Walker for Footer Menu to maintain MySpace styling
...
// Fallback function for when no custom menu is set
function myspace_footer_fallback_menu() {
    ?>
